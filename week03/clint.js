...
class Request{
    constructor(options){
        ...
        if(!this.headers["content-type"]){
            this.headers["content-type"]="application/x-www-form-urlenconded"
        }
        if(this.headers["content-type"]==="application/json"){
            this.bodyText=JSON.stringify(this.body)
        }else if(this.headers["content-type"]="application/x-www-form-urlenconded"){
...
class TrunkedBodyParser{
    ...
    receiveChar(char){
        ...
        }else if(this.current === WAITING_NEW_LINE ){
            if(char==='\r'){
